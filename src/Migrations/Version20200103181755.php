 ...
 */
final class Version20200103181755 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT AUTO_INCREMENT NOT NULL, cover_id INT DEFAULT NULL, title LONGTEXT NOT NULL, UNIQUE INDEX UNIQ_CBE5A331922726E9 (cover_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
